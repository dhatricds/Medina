...
export default function DashboardDetail() {
  const { dashboardDetail, dashboardDetailId, closeDashboardDetail, downloadDashboardExcel, loadDashboardToWorkspace } = useProjectStore();
    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="bg-card border-b border-border px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            className="px-4 py-2 rounded-md text-[13px] font-semibold flex items-center gap-1.5 bg-primary text-white hover:bg-primary/90 transition-all cursor-pointer"
            onClick={() => loadDashboardToWorkspace(dashboardDetailId)}
          >
